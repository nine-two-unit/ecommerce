							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											<input type="radio" id="method-boleto" name="payment-method" placeholder="Boleto" value="1" style="float:left; margin: 30px;">
											<label class="" for="method-boleto"><img style="height:64px;" src="/asset/site/img/logo-boleto.jpg"></label>
										</p>
										...
										<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
											...
											<label class="" for="method-paypal"><img style="height:64px;" src="/asset/site/img/logo-paypal.png"></label>
										</p>											
