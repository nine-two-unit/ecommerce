            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
							<!-- chamando o arquivo categories-menu atualizado dinamicamente por um método incluído nos métodos de alteração, cadastro e exclusão nos nomes das categorias -->
